...
export default function TimelineEvent({
    ...
    return (
        ...
        >
            <section className="bg-accent-100  min-w-[40rem] max-w-[40rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-accent-200 transition sm:group-even:pl-8 ">
